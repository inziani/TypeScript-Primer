...
myObject.writeMessage('Robina');

let myFunction = myObject.writeMessage;
myFunction('Its is rainy today')

// Using the bind function for the global this
...
myOtherObject.writeMessage = myOtherObject.writeMessage.bind(myOtherObject);

myOtherObject.writeMessage('Sunny today');
let myOtherFunction = myOtherObject.writeMessage;

myOtherFunction('Its windiry today');
